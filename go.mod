module github.com/pathfinder-cm/pathfinder-agent

go 1.12

require (
	github.com/BaritoLog/go-boilerplate v0.0.0-20180704035312-20c4c3002396
	...
	github.com/pathfinder-cm/pathfinder-go-client v0.0.0-20190709054203-ca1c8f97398a
